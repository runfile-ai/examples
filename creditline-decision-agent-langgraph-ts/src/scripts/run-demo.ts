// ============================================================================
// Deterministic end-to-end demo for the LangGraph build: one escalated,
...
// LangGraph agent's provenance, then simulates the officer override.
//
//   npm run demo
//
...
async function main() {
  console.log("=== Credit-Line Decision Agent (LangGraph) — deterministic demo ===\n");
