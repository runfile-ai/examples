...
Policy-driven so a decision can change by versioning the *policy*, not the code.
This module is the canonical scorer: the deterministic demo
(``scripts/run_demo.py``) calls it directly, and the live agent's *decisioning*
skill instructs the model to apply exactly these rules to the retrieved policy.
