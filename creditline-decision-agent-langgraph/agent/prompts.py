...
passes that exact value into ``creditline_record_decision`` — the same
provenance contract as the Claude and OpenAI builds, computed locally here.
"""
...
AGENT_ID = "creditline-decision-agent-langgraph"
AGENT_VERSION = "0.1.0"
MODEL = os.environ.get("AGENT_MODEL", "claude-sonnet-4-6")
MODEL_PROVIDER = os.environ.get("AGENT_MODEL_PROVIDER", "anthropic")
MODEL_VERSION = f"{MODEL_PROVIDER}:{MODEL}"
