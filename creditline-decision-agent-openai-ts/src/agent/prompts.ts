...
// passes that exact value into creditline_record_decision so a recorded decision
// pins precisely which prompt produced it — the same provenance contract as the
// Claude version, computed locally here instead of via an MCP tool.
import { createHash } from "node:crypto";

export const AGENT_ID = "creditline-decision-agent-openai";
